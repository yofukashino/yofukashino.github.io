...
export default React.memo(() => {
  ...
  return (
    <div className={`connections${shown ? " shown" : ""}`}>
      ...
      {shown && (
        <>
          <a data-tooltip="github" href="https://github.com/tharkidev">
            <Assets.connections.github className="connection-icon" />
          </a>
          <a data-tooltip="loneweeb" href="https://discord.com/users/1025214794766221384/">
          ...
          <a data-tooltip="rp plugins" href="https://github.com/tharkidev/RepluggedPlugins">
            <Assets.connections.plugin className="connection-icon" />
          </a>
          <a data-tooltip="instagram" href="https://www.instagram.com/tharkiahlawat/">
          ...
          <a data-tooltip="twitch" href="https://www.twitch.tv/tharkiahlawat">
